...
def process_questions_mulchoices(args):
    ...
    if args.mode in ['train']:
        ...
        if args.split_train:
            ...
            print('Loading train-all vocab')
            args.vocab_json = "data/{}/{}_all_vocab.json"
            with open(args.vocab_json.format(args.dataset,args.dataset),'r') as f:
                vocab = json.load(f)
            multichoice_encoding_data(args, vocab, questions, question_id, video_id, correct_idx, answer_candidates, mode='train')
